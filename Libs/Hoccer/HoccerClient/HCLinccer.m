...
- (void)overwriteLocationWithCoordinate:(CLLocationCoordinate2D )coordinate{
    [self.environmentController overwriteLocationWithCoordinate:coordinate];
    [self reactivate];
}
...
- (void)updateEnvironment {	
    ...
    NSMutableDictionary *environment = [[self.environmentController.environment dict] mutableCopy];
